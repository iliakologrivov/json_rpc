...
use IliaKologrivov\LaravelJsonRpcServer\Exception\JsonRpcException;
...
final class RequestResponse implements Jsonable, Arrayable
{
     ...
     * @return RequestResponse
     */
    public static function constructErrorResponse($id, string $message, int $code = ErrorCode::INTERNAL_ERROR, array $extras = []): RequestResponse
    {
        $defaultParams = [
            'code'    => $code,
        ...
        return new self($id, ($defaultParams + $extras), true);
    }
